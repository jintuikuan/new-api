...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/groups", permission: authz.ChannelWrite, handler: controller.CreateChannelGroup},
	{method: http.MethodPut, path: "/groups/:id", permission: authz.ChannelWrite, handler: controller.UpdateChannelGroup},
	{method: http.MethodDelete, path: "/groups/:id", permission: authz.ChannelWrite, handler: controller.DeleteChannelGroup},
	{method: http.MethodPost, path: "/groups/:id/status", permission: authz.ChannelOperate, handler: controller.UpdateChannelGroupStatus},
